...
class Controlador {
    ...
    //os parametros seguintes são parametros de saida
    
    //parametros passado pela url
    public static $parametros;
    
    //devolve o objeto da classe chamada pela url
    public static $out;
    
    //devolve a view 
    public static $outView;
    ...
    public static function executar(){
       ...
       //consome o parametro da view e caso haja parametros carrega na saida
       self::verificaUrl();
   ...
   public static function carregaConfiguracoesPhp(){
    ...
    public static function carregaView($view){
        ...
        //verifica se eiste uma view e existe no array de configuracao
        if($view != '' && isset($configView['view'][$view])){
            if(file_exists('view/'.$configView['view'][$view].".php")){
                self::$outView ='./view/'.$configView['view'][$view].'.php';
            }else{

            }
        }else{
                self::$outView = './view/'.$configView['view']['default'].'.php';                
        }
    }
    ...
    */
    public static function executarController($pagina,$server,$banco,
        ...
        if(isset($configController['controller'][$pagina])){
            if(file_exists("control/".$configController['controller'][$pagina].".php")){
